 ...
 * @author kriz
 */
public class registerBooker extends javax.swing.JFrame {

    /**
     * Creates new form Register
     */
    public registerBooker() {
        initComponents();
    ...
    private void btnRegisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegisterActionPerformed
        ...
        if(JOptionPane.showConfirmDialog(null, "Confirm if you want to register into booker", "Booker Register", JOptionPane.YES_NO_OPTION)==JOptionPane.YES_OPTION) {
            ...
            if(verifyFields()) {
                ...
                if(!checkUser(username)) {
                    ...
                    ResultSet rs;
                    String registerUserQuery = "INSERT INTO `user`(`full_name`, `username`, `password`, `address`, `phone`, `gender`) VALUES (?,?,?,?,?,?)";
                    ...
                    try {
                        ...
                        try {
                            ...
                            if (ps.executeUpdate() != 0) {
                                JOptionPane.showMessageDialog(null, "Your Booker Account Has been Created");
                            } else {
    ...
    public boolean verifyFields() {
        ...
        //check empty fields
        if (fname.trim().equals("") || uname.trim().equals("") || address.trim().equals("") || phone.trim().equals("")
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(registerBooker.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new registerBooker().setVisible(true);
            }
        });
    }
